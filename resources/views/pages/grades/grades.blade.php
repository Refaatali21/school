                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <label for="Name_en" class="mr-sm-2">{{ trans('grades_trans.stage_name_en') }}
                                :</label>
                            <input type="text" class="form-control" value="{{old('name_en')}}" name="name_en" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlTextarea1">{{ trans('grades_trans.notes') }}
                            :</label>
                        <textarea class="form-control" name="notes" value="{{old('notes')}}" id="exampleFormControlTextarea1"
                            rows="3"></textarea>
                    </div>
                    <br><br>
            </div>
