 ...
 header start-->
        <nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            ...
            <div class="text-left navbar-brand-wrapper">
                <a class="navbar-brand brand-logo" href="<?php echo e(route('dashboard')); ?>"><img src="<?php echo e(URL::asset('assets/images/logo-dark2.png')); ?>" alt=""></a>
            ...
            <div class="dropdown-menu">
                ...
                <li class="nav-item dropdown mr-30">
                    <a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button"
                        ...
                        <img src="<?php echo e(URL::asset('assets/images/profile-avatar.jpg')); ?>" alt="avatar">
                    </a>
        ...
        <!--=================================
 header End-->
<?php /**PATH C:\xampp\htdocs\School\resources\views/layouts/main-header.blade.php ENDPATH**/ ?>