...
unset($__errorArgs, $__bag); ?>
                                ...
                                <a class="button" href="<?php echo e(route('register')); ?>" ><span>تسجيل</span><i class="fa fa-check"></i></a>
                            </form>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\xampp\htdocs\School\resources\views/auth/login.blade.php ENDPATH**/ ?>